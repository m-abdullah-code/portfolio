...
const education = () => {
  return (
    <section id='education'
      className='py-24 pb-24 px-5 font-sans bg-skills-gradiant clip-path-custom-3'>
            ...
            >
              ...
              <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] z-2 ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
                ...
                <div className='flex items-center space-x-6'>
                  ...
                  {/* School logo */}
                  <div className='w-full max-w-16 h-16 bg-white rounded-md overflow-hidden'>
                    <img src={edu.img} alt={edu.school} className='w-full h-full object-cover' />
                  </div>

                  {/* Degree, School name and dates */}
